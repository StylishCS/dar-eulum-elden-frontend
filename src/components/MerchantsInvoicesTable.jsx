...
const TABLE_HEAD = ["ID","Client ID", "Amount", "Paid","Due","Profit","Issued At", "", ""];

export function MerchantsInvoicesTable({ invoices }) {
    ...
    <Card className="h-full w-full overflow-scroll">
      ...
      <CardBody className="p-0">
        <table className="w-full min-w-max table-auto text-left">
          ...
          <tbody>
            {currentInvoices.map(({ _id,UID,clientUID, profit,totalAmount, createdAt, paid, due }, index) => (
              <tr key={UID} className="bg-blue-gray-50/50">
                <td className="p-4">
                  <Typography
                    variant="small"
                    color="blue-gray"
